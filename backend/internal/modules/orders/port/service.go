...
type CreateOrderInput struct {
        ...
        // Restaurant location snapshot (from Catalog module).
        // Required for parallel dispatch: the dispatch engine needs the restaurant's
        // coordinates to find the nearest driver IMMEDIATELY when the order is created
        // (in parallel with merchant confirmation + food prep).

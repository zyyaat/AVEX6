...
// Consumed by: dispatch (start matching), notifications (notify merchant), audit.
...
// This event triggers the async dispatch flow — Orders does NOT wait for a response.

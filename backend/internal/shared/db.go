...
func createSchema() error {
        ...
        CREATE TABLE IF NOT EXISTS order_status_history (id TEXT PRIMARY KEY, order_id TEXT NOT NULL, status VARCHAR(30) NOT NULL, note TEXT, changed_by TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
        CREATE TABLE IF NOT EXISTS order_photos (id TEXT PRIMARY KEY, order_id TEXT NOT NULL, type VARCHAR(20) NOT NULL, url TEXT NOT NULL, uploaded_by TEXT, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
        CREATE TABLE IF NOT EXISTS zone_transfer_requests (id TEXT PRIMARY KEY, driver_id TEXT NOT NULL, from_zone_id TEXT, to_zone_id TEXT NOT NULL, status VARCHAR(20) DEFAULT 'pending', reason TEXT, requested_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, reviewed_at TIMESTAMP, reviewed_by TEXT, admin_note TEXT);
        `
...
func runMigrations() error {
        ...
        migrations := []string{
                ...
                "ALTER TABLE delivery_zones ADD COLUMN IF NOT EXISTS polygon_geojson TEXT",
                "ALTER TABLE delivery_zones ADD COLUMN IF NOT EXISTS color VARCHAR(16)",
                "ALTER TABLE drivers ADD COLUMN IF NOT EXISTS zone_id TEXT",
                "ALTER TABLE drivers ADD COLUMN IF NOT EXISTS photo_url TEXT",
                "ALTER TABLE orders ADD COLUMN IF NOT EXISTS snapshot_json TEXT",
                "ALTER TABLE orders ADD COLUMN IF NOT EXISTS pickup_photo_url TEXT",

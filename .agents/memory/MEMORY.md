...
- [Wouter wildcard root-path bug](wouter-rest-wildcard-root-bug.md) — `:param*` wildcard routes never match bare `/`, causing blank white screens; add an explicit `/` route too
